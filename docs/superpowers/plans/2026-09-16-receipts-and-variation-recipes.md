...
- [x] **Step 1: Write failing API tests for cashier snapshots**
...
- [x] **Step 1: Write failing permission, creation, and update tests**
...
- [x] **Step 3: Write failing inactive-read tests**
...
- [x] **Step 4: Write the failing future-sales integration test**
...
- [x] **Step 6: Define strict request schemas**
...
- [x] **Step 7: Implement atomic create and update services**
...
- [x] **Step 8: Register manager-only routes**
...
- [x] **Step 9: Make manager catalog reads complete**
...
- [x] **Step 10: Add rollback coverage**
...
- [x] **Step 3: Extend types and `POSClient`**
...
- [x] **Step 4: Implement `ApiClient` methods**
...
- [x] **Step 5: Update complete catalog fixtures and verify GREEN**
...
- [x] **Step 2: Write failing creation, validation, and modifier tests**
...
- [x] **Step 4: Implement the focused component**
...
- [x] **Step 5: Integrate with Settings**
...
- [x] **Step 7: Update manager/owner tour wording**
...
- [x] **Step 8: Verify GREEN and integration**
...
- [x] **Step 1: Write the failing receipt-content test**
...
- [x] **Step 2: Write failing external-payment and refund tests**
...
- [x] **Step 4: Extract and implement the receipt**
...
- [x] **Step 5: Implement thermal print CSS**
...
- [x] **Step 6: Update immediate and historical receipt paths**
...
- [x] **Step 1: Extend the owner browser scenario**
...
- [x] **Step 2: Extend the sale browser scenario**
...
- [x] **Step 3: Add print-width visual evidence**
...
- [x] **Step 4: Run the focused browser scenario and verify RED/GREEN**
...
- [x] **Step 7: Verify a production-style migration**
...
- [x] **Step 8: Commit the release evidence**
...
- [x] **Step 9: Review final history and publish**
